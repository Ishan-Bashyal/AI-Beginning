...
# Load data
df = pd.read_csv("/Users/ishan-college/Downloads/smsspamcollection-43213e63-5452-42f4-9233-27e2a444cd31/SMSSpamCollection", sep='\t', header=None, names=['label', 'message'])
